export const carousalData = [
  ...
  {
    img: "/assets/slider3.webp",
    header: "Diploma Universitario en Proyectos Inmobiliarios",
    description:
  ...
  {
    img: "/assets/slider5.webp",
    header: "Licenciatura en Corretaje y Negocios Inmobiliarios",
    description:
      "Tendrás el máximo nivel de formación, con una visión integral del mundo del Real State, profundos conocimientos de las estrategias y un amplio abanico de vínculos para desarrollo de negocios. ",
  },
];
